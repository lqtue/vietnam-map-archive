...
- `docs/ponytail-debt.md` — ledger of `ponytail:` shortcut comments. The plugin that generated it is gone (Sept 2026); maintain it by hand or `grep -rn 'ponytail:' src/ work/ scripts/`
