# Roadmap — single entry point (updated 2026-09-22)

One list. Everything else is detail or history. Update this file, not the others.

**Read the first section and stop.** Everything below *Start here* is either a previous first
list kept for its record, or a done section kept for what it cost to learn. Sections run newest
first, down to the tracks, which are oldest.
...
**Closed in this pass (2026-09-21), kept for the caveats they raise:**
